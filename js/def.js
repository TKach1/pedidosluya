...
item.add("Pega Marido" , "6.50", "", "tempero");
...
item.add("Amendoim Cebola e Salsa" , "4.00", "Amendoim Cebola e Salsa.webp", "ape");
...
item.add("Amendoim Japonês" , "4.00", "Amendoim Japonês.webp", "ape");
item.add("Amendoim Picante" , "4.00", "amendoim-picante-kg.png", "ape");
...
item.add("Amendoim Tradicional" , "4.00", "amendoim.jpg", "ape");
...
item.add("Biscoito Cokkie Castanha" , "8.00", " ", "ape");
