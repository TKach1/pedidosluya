...
item.add("Biscoito Vaidosa" , "4.00", "Vaidosa.jpg", "ape");
item.add("Biscoito Laka" , "4.00", "laka.jpg", "ape");
item.add("Torrada Alho" , "5.00", "torradinha.jpeg", "ape");
item.add("Torrada Bacon EM FALTA" , "5.00", "torradinha.jpeg", "ape");
item.add("Torrada Queijo EM FALTA" , "5.00", "torradinha.jpeg", "ape");
item.add("Torrada Ervas Finas" , "5.00", "torradinha.jpeg", "ape");
