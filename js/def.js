...
item.add("Alho Granulado EM FALTA", "5.00", "alho-granulado.jpg", "tempero");
...
item.add("Chá 7 Ervas EM FALTA" , "3.50", "Cha7Ervas.jpg", "ervanario");
...
item.add("Graviola EM FALTA" , "3.10", "GraviolaSeca.jpg", "ervanario");
...
item.add("Damasco Jumbo EM FALTA" , "11.00", "Damasco-Jumbo.webp", "frutas");
...
item.add("Arroz Arbóreo EM FALTA" , "2.90", "Arroz Arbóreo.jpg", "graos");
...
item.add("Granola Completa S/ Açúcar EM FALTA" , "4.70", "Granola Completa.jpg", "graos");
...
item.add("Milho de Pipoca Gourmet" , "4.50", "Milho de Pipoca Gourmet.webp", "graos");
item.add("Pepita de Girassol" , "3.80", "Pepita de Girassol.jpg", "graos");
item.add("PTS" , "3.60", "PTS.webp", "graos");
item.add("Semente de Abóbora", "7.50", "semente_de_abobora_sem_casca.webp", "graos");
...
item.add("Aipim Chips Churrasco" , "9.00", "Aipim Chips.png", "ape");
item.add("Aipim Chips Bacon" , "9.00", "Aipim Chips.png", "ape");
...
item.add("Drageado de Maracujá Gourmet EM FALTA" , "19.00", "dragmarac.jpeg", "ape");
...
item.add("Laranja Cristal Tiras" , "8.50", "Laranja Cristal Tiras.webp", "ape");
item.add("Milho Espanhol Mostarda/Mel" , "7.00", "Milho Espanhol MostardaMel.jpg", "ape");
item.add("Snack Cebola e Salsa EM FALTA" , "10.00", "Snack CebolaSalsa.webp", "ape");
item.add("Biscoito Vaidosa " , "4.20", "Vaidosa.jpg", "ape");
item.add("Biscoito Laka " , "4.20", "laka.jpg", "ape");
...
item.add("Bicarbonato de Sódio" , "1.20", "Bicarbonato de Sódio.webp", "conf");
...
item.add("Laranja Premium Chá/Drinks EM FALTA" , "12.00", "Laranja Premium.jpg", "conf");
...
item.add("Stevia" , "8.50", "stevia-1.jpg", "conf");
...
item.add("Tapioca EM FALTA" , "1.50", "Tapioca.webp", "conf");
item.add("Tapioca Granulada" , "1.50", "Tapioca.webp", "conf");
item.add("Xilitol Cristal" , "7.00", "Xilitol Cristal.webp", "conf");
