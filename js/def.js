...
item.add("Salsa Desidratada EM FALTA" , "4.00", "SalsaDesidratada.jpg", "tempero");
...
item.add("Amaranto Flocos EM FALTA" , "7.00", "Amaranto Flocos.jpg", "farin");
...
item.add("Lentilha canadense EM FALTA" , "2.80", "Lentilha canadense.png", "graos");
...
item.add("Semente de Abóbora EM FALTA", "7.50", "semente_de_abobora_sem_casca.webp", "graos");
...
item.add("Torrada Bacon EM FALTA" , "5.50", "torradinha.jpeg", "ape");
item.add("Torrada Queijo" , "5.50", "torradinha.jpeg", "ape");
item.add("Torrada Ervas Finas EM FALTA" , "5.50", "torradinha.jpeg", "ape");
