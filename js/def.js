...
item.add("Chimichurri S/ Pimenta - EM FALTA" , "5.50", "ChimichurriSPimenta.jpg", "tempero");
...
item.add("Ameixas sem caroço EM FALTA " , "7.20", "Ameixas sem caroço.webp", "frutas");
...
item.add("Damasco Jumbo EM FALTA " , "11.50", "Damasco-Jumbo.webp", "frutas");
...
item.add("Drageado Praline de Amêndoas" , "19.50", "praline.jpeg", "ape");
...
item.add("Biscoito Goiabada" , "4.20", " ", "ape");
