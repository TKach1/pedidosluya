...
item.add("Alho em Pó", "4.00", "alhoempo.jpg", "tempero");
...
item.add("Mostarda em pó" , "4.00", "Mostardaempo.webp", "tempero");
...
item.add("Páprica Defumada" , "4.00", "PapricaDefumada.webp", "tempero");
item.add("Páprica Picante" , "4.00", "PapricaPicante.jpg", "tempero");
item.add("Páprica Pega Marido" , "6.50", "", "tempero");
...
item.add("Aipim Chips Cebola/SalsA" , "10.50", "aipim_cebola_e_salsa.jpg", "ape");
item.add("Aipim Chips" , "10.50", "Aipim Chips.png", "ape");
item.add("Aipim Chips Bacon" , "10.50", "Aipim Chips.png", "ape");
item.add("Amendoim Cebola e Salsa" , "3.60", "Amendoim Cebola e Salsa.webp", "ape");
item.add("Amendoim com Chocolate" , "4.00", "Amendoim com Chocolate.webp", "ape");
item.add("Amendoim Caramelizado" , "4.00", "amendoim-caramelado.jpg", "ape");
item.add("Amendoim Japonês" , "3.60", "Amendoim Japonês.webp", "ape");
item.add("Amendoim Picante" , "3.60", "amendoim-picante-kg.png", "ape");
...
item.add("Amendoim Tradicional" , "3.60", "amendoim.jpg", "ape");
item.add("Batata Chips Queijo " , "13.50", "batata-chips-mexicana.jpg", "ape");
item.add("Drageado de Cappuccino", "21,00", "capuccino.jpeg", "ape");
item.add("Drageado Crocante", "13.00", "crocante.jpeg", "ape");
item.add("Drageado Caju Bland " , "21,00", "caju.jpeg", "ape");
item.add("Drageado de Nutella " , "21,00", "nutellas.jpeg", "ape");
item.add("Drageado de Uva Passa" , "13.00", "uvapassa.jpeg", "ape");
item.add("Drageado de Banana" , "13.00", "banana.jpeg", "ape");
item.add("Drageado de Cereja " , "21,00", "dragxereja.jpeg", "ape");
item.add("Drageado de Maracujá Gourmet" , "21,00", "dragmarac.jpeg", "ape");
item.add("Fini Bananinha" , "7.20", "Fini Bananinha.jpg", "ape");
item.add("Fini Beijos de Morango" , "7.20", "Beijos-de-morango-2.webp", "ape");
item.add("Fini Dentadura" , "7.20", "Fini Dentadura.jpeg", "ape");
item.add("Fini Marshmallow" , "7.20", "marshmallowFini.webp", "ape");
item.add("Fini Ursinho Brilho" , "7.20", "Fini Minhoca Brilho.jpg", "ape");
item.add("Fini Minhoca Cítrica" , "7.20", "Fini Minhoca Cítrica.jpg", "ape");
...
item.add("Biscoito Vaidosa " , "5.00", "Vaidosa.jpg", "ape");
item.add("Biscoito Laka" , "5.00", "laka.jpg", "ape");
item.add("Biscoito Goiabada" , "5.00", " ", "ape");
