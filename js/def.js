...
item.add("Semente de Abóbora", "1.90", "semente_de_abobora_sem_casca.webp", "graos");
...
item.add("Biscoito Vaidosa" , "4.00", "uaivaidosa.jpeg", "ape");
item.add("Biscoito Laka" , "4.00", "Uai Laka.jpg", "ape");
