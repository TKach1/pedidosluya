...
item.add("Alho Granulado ", "5.50", "alho-granulado.jpg", "tempero");
...
item.add("Chimichurri C/ Pimenta" , "6.00", "ChimichurriCPimenta.jpg", "tempero");
item.add("Chimichurri S/ Pimenta" , "6.00", "ChimichurriSPimenta.jpg", "tempero");
...
item.add("Lemon Pepper" , "5.50", "LemonPepper.webp", "tempero");
...
item.add("Mostarda em pó" , "4.50", "Mostardaempo.webp", "tempero");
...
item.add("Tempero para feijão" , "5.00", "", "tempero");
...
item.add("Aipim Chips Cebola/SalsA" , "11.90", "aipim_cebola_e_salsa.jpg", "ape");
item.add("Aipim Chips" , "11.90", "Aipim Chips.png", "ape");
item.add("Aipim Chips Bacon" , "11.90", "Aipim Chips.png", "ape");
