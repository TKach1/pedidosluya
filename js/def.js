...
item.add("Açafrão em pó", "3.30", "açafrao.jpg", "tempero");
item.add("Alecrim", "4.", "alecrim_desidratado.webp", "tempero");
item.add("Alho em Pó", "2.80", "alhoempo.jpg", "tempero");
item.add("Alho Granulado", "4.80", "alho-granulado.jpg", "tempero");
item.add("Alho Poró", "7.40", "alho_poro.jpg", "tempero");
...
item.add("Cebolinha" , "4.00", "cebolinha-verde.jpg", "tempero");
...
item.add("Cravo Flor" , "12.50", "CravoFlor.jpg", "tempero");
...
item.add("Endro" , "2.50", "2457_endro_desidratado.jpg", "tempero");
...
item.add("Molho Tártaro" , "6.00", "molho-tartaro.png", "tempero");
...
item.add("Sal Rosa Fino" , "1.20", "SalRosaFino.jpg", "tempero");
item.add("Sal Rosa Grosso" , "1.20", "SalRosaGrosso.webp", "tempero");
...
item.add("tempero para feijão EM FALTA" , "4.00", "", "tempero");
...
item.add("Erva Doce EM FALTA" , "4.50", "ErvaDoce.webp", "ervanario");
...
item.add("Hortelã EM FALTA" , "3.50", "Hortela.webp", "ervanario");
...
item.add("Amêndoa Laminada" , "11.00", "amendoa_laminada.png", "frutas");
...
item.add("Castanha do Pará Inteira" , "11.00", "Castanha do Pará Inteira.png", "frutas");
item.add("Castanha do Pará Quebrada" , "9.00", "Castanha do Pará Quebrada.png", "frutas");
item.add("Mix de Frutas" , "10.50", "Mix de Frutas.png", "frutas");
item.add("Damasco Jumbo" , "10.00", "Damasco-Jumbo.webp", "frutas");
item.add("Maçã Chips" , "10.00", "maca_desidratada_chips.webp", "frutas");
...
item.add("Farinha de Amenduim" , "2.60", "farinha_de_amendoim.webp", "farin");
...
item.add("Farinha de Chia" , "2.50", "Farinha de Chia.webp", "farin");
...
item.add("Milho de Pipoca Gourmet" , "3.90", "Milho de Pipoca Gourmet.webp", "graos");
item.add("Pepita de Girassol" , "3.50", "Pepita de Girassol.jpg", "graos");
item.add("PTS" , "3.60", "PTS.webp", "graos");
item.add("Semente de Abóbora", "7.00", "semente_de_abobora_sem_casca.webp", "graos");
...
item.add("Aipim Chips Cebola/Salsa" , "8.30", "aipim_cebola_e_salsa.jpg", "ape");
item.add("Aipim Chips" , "8.30", "Aipim Chips.png", "ape");
item.add("Aipim Chips Churrasco" , "8.30", "Aipim Chips.png", "ape");
...
item.add("Batata Chips Queijo" , "10.00", "batata-chips-mexicana.jpg", "ape");
...
item.add("Fini Marshmallow" , "6.00", "marshmallowFini.webp", "ape");
item.add("Fini Ursinho Brilho" , "6.00", "Fini Minhoca Brilho.jpg", "ape");
...
item.add("Biscoito Vaidosa EM FALTA " , "4.00", "Vaidosa.jpg", "ape");
item.add("Biscoito Laka EM FALTA" , "4.00", "laka.jpg", "ape");
item.add("Torrada Alho" , "5.00", "torradinha.jpeg", "ape");
item.add("Torrada Bacon" , "5.00", "torradinha.jpeg", "ape");
item.add("Torrada Queijo EM FALTA" , "5.00", "torradinha.jpeg", "ape");
item.add("Torrada Ervas Finas EM FALTA" , "5.00", "torradinha.jpeg", "ape");
...
item.add("Chocolate em Pó 70%" , "8.00", "Chocolate em Pó.png", "conf");
item.add("Coco Flocos Médio S/ Açúcar" , "4.90", "Coco Flocos.png", "conf");
item.add("Goma Xantana" , "12.00", "Goma Xantana.webp", "conf");
...
item.add("Sucrilhos Com Açúcar EM FALTA" , "2.90", "Sucrilhos Com Açúcar.jpg", "conf");
item.add("Sucrilhos Sem Açúcar" , "2.90", "sucrilhos-acucar.png", "conf");
item.add("Tapioca" , "1.50", "Tapioca.webp", "conf");
item.add("Tapioca Granulada" , "1.50", "Tapioca.webp", "conf");
