...
item.add("Açafrão em pó", "4.00", "açafrao.jpg", "tempero");
item.add("Alecrim", "4.00", "alecrim_desidratado.webp", "tempero");
item.add("Alho em Pó", "3.20", "alhoempo.jpg", "tempero");
...
item.add("Chimichurri C/ Pimenta" , "5.50", "ChimichurriCPimenta.jpg", "tempero");
item.add("Chimichurri S/ Pimenta" , "5.50", "ChimichurriSPimenta.jpg", "tempero");
...
item.add("Creme de Cebola" , "2.20", "CremedeCebola.png", "tempero");
...
item.add("Castanha de Caju Caramelizada" , "9.00", "Castanha de Caju Caramelizada.jpg", "frutas");
item.add("Castanha de Caju C/ Sal" , "11.50", "Castanha de Caju.webp", "frutas");
item.add("Castanha de Caju S/ Sal" , "11.50", "Castanha de Caju.webp", "frutas");
