...
item.add("Hibiscos" , "6.00", "Hibiscos.jpg", "ervanario");
...
item.add("Noz Pecan" , "15.00", "Noz Pecan.webp", "frutas");
...
item.add("Farinha de Beterraba " , "9.19", "farinha-de-beterraba.jpg", "farin");
...
item.add("Farinha da Felicidade" , "5.99", "Farinha Maca Peruana.webp", "farin");
...
item.add("Gergelim Preto" , "4.70", "gergelim_preto.webp", "graos");
...
item.add("Banana Chips com Canela" , "10.00", "Banana Chips.webp", "ape");
item.add("Banana Chips Salgada" , "10.00", "Banana Chips.webp", "ape");
item.add("Coquinho caramelizado com leita condensado" , "6.60", "coco_caramelizado.jpeg", "ape");
...
item.add("Drageado de Limão Siciliano " , "22,00", "dragea_limao.webp", "ape");
...
item.add("Leite de Coco em Pó" , "10.00", "Leite de Coco em Pó.webp", "conf");
