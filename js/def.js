...
item.add("Castanha Mix EM FALTA" , "10.00", "Castanha Mix.webp", "frutas");
item.add("Castanha do Pará Inteira" , "11.00", "Castanha do Pará Inteira.png", "frutas");
item.add("Castanha do Pará Quebrada EM FALTA" , "9.00", "Castanha do Pará Quebrada.png", "frutas");
...
item.add("Aipim Chips Cebola/Salsa EM FALTA" , "9.00", "aipim_cebola_e_salsa.jpg", "ape");
...
item.add("Batata Chips Queijo EM FALTA" , "12.00", "batata-chips-mexicana.jpg", "ape");
...
item.add("Drageado de Cereja EM FALTA" , "19.00", "dragxereja.jpeg", "ape");
...
item.add("Cacau em Pó EM FALTA" , "2.90", "Cacau em Pó.webp", "conf");
